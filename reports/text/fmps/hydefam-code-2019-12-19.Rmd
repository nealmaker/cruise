...
parcels <- str_split(parcel_ids, ", ", simplify = T)
```
...
\noindent 2020 - No scheduled activity
...
\noindent 2025 – No scheduled activity
...
\noindent 2029 – Management plan update; boundary line maintenance
