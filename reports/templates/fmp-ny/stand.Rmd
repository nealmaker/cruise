...
\noindent `r sprintf("%.2f", ifelse(!is.na((stands %>% filter(stand == i))$ineligible_roads_landings), (stands %>% filter(stand == i))$ineligible_roads_landings, 0))` acres ineligible roads and landings     
