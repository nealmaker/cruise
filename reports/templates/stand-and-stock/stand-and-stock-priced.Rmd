...
<<<<<<< HEAD
\Large `r if(exists("jurisdiction")) paste0("Town of ", str_trim(str_split(jurisdiction, ",")[[1]][[1]]), ", ", str_trim(str_split(jurisdiction, ",")[[1]][[2]]), " County, New York") else if(exists("town")) paste0(town, ", Vermont")`
=======
\Large Town of `r str_trim(str_split(jurisdiction, ",")[[1]][[1]])`, `r str_trim(str_split(jurisdiction, ",")[[1]][[2]])` County NY
>>>>>>> d3a3137c9e9b9e57de1d322b1a2a805115123f78

\vspace{120pt}

\large Prepared `r format(lubridate::today(), format = "%B %d, %Y")` by:
...
res <- lapply(stands$stand, function(i) {
  knitr::knit_child(
    'stand-priced.Rmd', envir = environment(), quiet = TRUE
  )
})
