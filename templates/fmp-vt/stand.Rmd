...
\vspace{2pt}
6-10”: `r (sum(filter(trees, stand == i, dbh >= 6, dbh <= 10)$live == 0)*baf)/(filter(stands, stand == i)$plots)` ft^2^/ac | 11-16”: `r (sum(filter(trees, stand == i, dbh > 10, dbh <= 16)$live == 0)*baf)/(filter(stands, stand == i)$plots)` ft^2^/ac | 17-22”: `r (sum(filter(trees, stand == i, dbh > 17, dbh <= 22)$live == 0)*baf)/(filter(stands, stand == i)$plots)` ft^2^/ac | 23+”: `r (sum(filter(trees, stand == i, dbh > 22)$live == 0)*baf)/(filter(stands, stand == i)$plots)` ft^2^/ac  
